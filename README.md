...
`capacity_gb` (p. ex. `16 GB`), `recommended` i `alternatives`, amb nom, precisió i CLAM).
`repo_url` enllaça el recomanat amb `link_column="recommended"` al shortcode; l'alternativa és text.
