...
MODELS = [
    {
        "label": "whisper-tiny",
        "args": ["whisper-tiny"],
        "output": "evals/whisper_tiny.json",
    },
    {
        "label": "whisper-base",
        "args": ["whisper-base"],
        "output": "evals/whisper_base.json",
    },
    {
        "label": "whisper-small",
        "args": ["whisper-small"],
        "output": "evals/whisper_small.json",
    },
    {
        "label": "whisper-medium",
        "args": ["whisper-medium"],
        "output": "evals/whisper_medium.json",
    },
    {
        "label": "whisper-large-v3",
        "args": ["whisper-large-v3"],
        "output": "evals/whisper_large_v3.json",
    },
    {
        "label": "whisper-large-v3-turbo",
        "args": ["whisper-large-v3-turbo"],
        "output": "evals/whisper_large_v3_turbo.json",
    },
    {
        "label": "whisper-large-v3-ca",
        "args": ["projecte-aina/whisper-large-v3-ca-3catparla"],
        "output": "evals/whisper_large_v3_ca.json",
    },
    {
        "label": "omniASR_CTC_300M",
        "args": ["omniASR_CTC_300M"],
        "output": "evals/omni_ctc_300m.json",
    },
    {
        "label": "omniASR_CTC_1B",
        "args": ["omniASR_CTC_1B"],
        "output": "evals/omni_ctc_1b.json",
    },
    {
        "label": "omniASR_CTC_3B",
        "args": ["omniASR_CTC_3B"],
        "output": "evals/omni_ctc_3b.json",
    },
    {
        "label": "omniASR_CTC_7B",
        "args": ["omniASR_CTC_7B"],
        "output": "evals/omni_ctc_7b.json",
    },
    {
        "label": "omniASR_LLM_300M",
        "args": ["omniASR_LLM_300M"],
        "output": "evals/omni_llm_300m.json",
    },
    {
        "label": "omniASR_LLM_1B",
        "args": ["omniASR_LLM_1B"],
        "output": "evals/omni_llm_1b.json",
    },
    {
        "label": "omniASR_LLM_3B",
        "args": ["omniASR_LLM_3B"],
        "output": "evals/omni_llm_3b.json",
    },
    {
    ...
    },
    {
        ...
        "output": "evals/gemini_3_8_flash_asr.json",
    ...
    },
    {
        ...
        "output": "evals/gemini_3_pro_preview_asr.json",
        "needs_google_api_key": True,
    },
]
